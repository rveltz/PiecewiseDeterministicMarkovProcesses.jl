...
function cvode_optim{f,r}(::Type{f},::Type{r},d::Array{Int64},p::Vector{Float64}, y0::Vector{Float64}, t::Vector{Float64}; reltol::Float64=1e-4, abstol::Float64=1e-6)
  neq = length(y0)
  mem = Sundials.CVodeCreate(Sundials.CV_BDF, Sundials.CV_NEWTON)
  flag = Sundials.CVodeInit(mem, cfunction(cvode_ode_wrapper, Int32, (Sundials.realtype, Sundials.N_Vector, Sundials.N_Vector, Array{Any,1})), t[1], Sundials.nvector(y0))
  flag = Sundials.CVodeSetUserData(mem, {f,r,d,p})
...
function evolve{f,r}(yres::Array{Float64,2}, mem, ::Type{f},::Type{r},d::Array{Int64},p::Vector{Float64},y0::Vector{Float64}, t::Vector{Float64})
